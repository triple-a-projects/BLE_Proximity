...
class TeacherPhoneAuth extends StatefulWidget {
  const TeacherPhoneAuth({Key? key}) : super(key: key);

  @override
  State<TeacherPhoneAuth> createState() => _TeacherPhoneAuthState();
}

class _TeacherPhoneAuthState extends State<TeacherPhoneAuth> {
